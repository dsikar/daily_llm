...
#SBATCH --job-name qwarr157B # Job name 8 characters or less
...
#SBATCH --array=1-20                                    # Run this script 10 times
...
modifier=(12 34 56 78 90 123 134 345 1234 2345)

python qwen1.5-7B.py --arg ${modifier[$SLURM_ARRAY_TASK_ID - 1]}
